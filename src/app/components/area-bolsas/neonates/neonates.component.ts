...
@Component({
  ...
  templateUrl: './neonates.component.html',
  styleUrl: './neonates.component.css',
  encapsulation: ViewEncapsulation.None
})
export class NeonatesComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.searchControl.valueChanges
      ...
      .subscribe((value) => {
        ...
        if(value && value.trim()!=""){
          this.nurseService.getNeonatesNurses$(value).subscribe(
            data => {
